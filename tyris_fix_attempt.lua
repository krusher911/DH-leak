...
local chatSpams = {
    ["Tyrisware"] = {
        "ðŸ˜‚ Dumping? Thought so... ðŸ˜¡ Start using Tyrisware to up your game ðŸ˜ðŸ˜", 
        "ðŸ§ Tyrisware has predicted your movements to the grave.", 
        "ðŸ¤¥ You'd be lying if you said you didn't want Tyrisware!!",
		...
		"ðŸ§‘â€ðŸ¦½ That desync doesn't look very \"walkable\" to me son..",
    ...
    ["Fulcrum"] = {
        ...
        "ðŸ‘½ðŸ‘½ BLASTED INTO SPACEINGTON ðŸ›¸ðŸ›¸",
        "Out here in yodieland using Tyrisingtonware! Shall we?"
    },
    ["Troll"] = {
        "ðŸ˜ Noob",
        "ðŸ¤” What's happening???",
        "Whats happening ðŸ¤” Stop shooting the airðŸ˜¤",
        "Go ahead report me ðŸ¤“ It's so hard to make a new account ðŸ˜­",
        "â˜¢ WELCOME TO YOUR DOOM â˜¢",
        "Show me a picture of your bank pooronðŸ“±ðŸ¦ðŸ’µ"
    }
}
